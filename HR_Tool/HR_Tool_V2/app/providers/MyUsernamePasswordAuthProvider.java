...
public class MyUsernamePasswordAuthProvider
	...
	public static class MyRecruiterSignup extends MySignup {
    ...
    public static final Form<MyRecruiterSignup> RECRUITER_ADD_FORM = form(MyRecruiterSignup.class);
    ...
    public Form<MyRecruiterSignup> getRecruiterAddForm() {
        return RECRUITER_ADD_FORM;
    }
    ...
    protected Body getVerifyEmailMailingBody(final String token,
        ...
        try {
            ...
            message.setSubject("EMail-Verifizierung für HR-Tool");
            message.setText("Hallo " + user.getName() + ","
                    + "\n\n Sie müssen auf den folgenden Link klicken, um Ihr Konto zu überprüfen" + "\n\n " + url + "\nGrüße,\nHr Tool Interne Team");
    ...
    protected Body getPasswordResetMailingBody(final String token,
        ...
        try {
            ...
            message.setSubject("HR Tool Interne - Passwort zurücksetzen");
            message.setText("Hallo " + user.name + ","
                    + "\n\n Bitte klicken Sie auf den folgenden Link, um Ihr Benutzerkennwort zurückzusetzen" + "\n\n " + url + "\nGrüße,\nHr Tool Interne Team");
    ...
    public static void AddRecruiterToUsers(final User user,final MySignup signupObj,
                                                  final Context ctx) {
        user.roles = Collections.singletonList(SecurityRole
         ...
         signupObj.repeatPassword = "123456";
        final MyUsernamePasswordAuthUser authUser = provider.buildSignupAuthUser(signupObj, ctx);
